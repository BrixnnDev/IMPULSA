export default function WelcomeScreen({ onPair }) {
  return (
    <div className="screen">
      <div style={{
        ...
        <p style={{
          ...
          Conecta tu PC con el servidor de monitoreo
        </p>
        ...
        <div className="social-icons" style={{
          ...
          <a href="https://x.com" target="_blank" rel="noreferrer" className="social-icon" title="X / Twitter">
        ...
        <p className="tagline" style={{
          ...
          Impresiones · Escaneos · Tiempo real
        </p>
      </div>
    </div>
  )
