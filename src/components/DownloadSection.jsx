import { FiSmartphone, FiMonitor, FiDownload, FiGlobe, FiArrowRight, FiLock, FiZap } from 'react-icons/fi'
...
const STORES = [
  ...
  },
  {
    ...
    icon: FaWindows,
    deviceIcon: FiMonitor,
    tagline: 'Para Windows 10/11',
    badgeColor: 'from-blue-600 to-blue-700',
    ringColor: 'ring-blue-500/30',
    hoverBorder: 'hover:border-blue-500/50',
    bgColor: 'bg-blue-500/10',
    textColor: 'text-blue-400',
    url: 'https://apps.microsoft.com/detail/stockflow/9N1234567890',
    alt: 'Descargar en Microsoft Store',
  },
]
...
export default function DownloadSection() {
  return (
    <section
      id="descarga"
      className="relative scroll-mt-20 overflow-hidden border-t border-white/5"
      aria-labelledby="descarga-title"
    >
        ...
        <div className="mt-10">
          ...
          {[
            ...
            <div key={i} className="panel p-6 transition hover:border-blue-500/30">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-blue-500/10 text-blue-400 ring-1 ring-blue-500/20">
                <Icon size={20} />
              </div>
